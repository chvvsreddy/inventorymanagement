...
const Sidebar = () => {
  ...
  return (
    <div className={sidebarClassNames}>
      {/* TOP LOGO */}
      <div className={`flex gap-3 justify-between md:justify-normal items-center ${isSidebarCollapsed? "px-5" : "px-8"}`} >
      <Image
          src="https://inventorymanangement-s3.s3.ap-south-1.amazonaws.com/logo.png"
          alt="Reddy-logo"
          width={27}
          height={27}
